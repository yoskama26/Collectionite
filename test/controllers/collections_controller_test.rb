...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference("Collection.count") do
      post collections_url, params: { collection: { collector_id: @collection.collector_id, name: @collection.name } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { collector_id: @collection.collector_id, name: @collection.name } }
